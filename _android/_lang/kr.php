...
store_version_name=템플릿: Android 모듈
store_version_description=이 예제 모듈은 이 CMS 내에서 Android 모듈 확장의 작동 방식을 보여줍니다. 다양한 폴더의 사용 방법을 설명하는 README 파일이 포함되어 있으며, 자신만의 Android 모듈을 만들기 위한 골격 템플릿을 제공합니다.

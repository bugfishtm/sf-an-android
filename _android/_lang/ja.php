...
store_version_name=テンプレート: Androidモジュール
store_version_description=このサンプルモジュールは、このCMS内でAndroidモジュール拡張機能の動作を示しています。フォルダの使用方法を説明するREADMEファイルが含まれており、独自のAndroidモジュールを作成するためのスケルトンテンプレートが提供されています。
